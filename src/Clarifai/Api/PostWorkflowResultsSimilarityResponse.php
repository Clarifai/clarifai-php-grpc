 ...
 *
 * Generated from protobuf message <code>clarifai.api.PostWorkflowResultsSimilarityResponse</code>
 */
class PostWorkflowResultsSimilarityResponse extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Clarifai\Api\WorkflowResultsSimilarity::class);
        $this->results = $arr;
