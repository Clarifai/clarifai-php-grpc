...
/**
 * Generated from protobuf message <code>clarifai.api.MultiDatasetVersionExportResponse</code>
 */
class MultiDatasetVersionExportResponse extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Clarifai\Api\DatasetVersionExport::class);
        $this->exports = $arr;
