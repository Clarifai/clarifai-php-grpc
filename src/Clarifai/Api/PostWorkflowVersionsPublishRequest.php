...
/**
 * Generated from protobuf message <code>clarifai.api.PostWorkflowVersionsPublishRequest</code>
 */
class PostWorkflowVersionsPublishRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Clarifai\Api\WorkflowVersionPublishRequest::class);
