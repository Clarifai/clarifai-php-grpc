 ...
 *
 * Generated from protobuf message <code>clarifai.api.MultiConceptRelationResponse</code>
 */
class MultiConceptRelationResponse extends \Google\Protobuf\Internal\Message
{
    /**
     * The response status.
     *
