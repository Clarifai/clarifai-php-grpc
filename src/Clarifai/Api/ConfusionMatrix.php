...
class ConfusionMatrix extends \Google\Protobuf\Internal\Message
{
     ...
     *
     *     @type array<\Clarifai\Api\ConfusionMatrixEntry>|\Google\Protobuf\Internal\RepeatedField $matrix
    ...
    /**
     * Generated from protobuf field <code>repeated .clarifai.api.ConfusionMatrixEntry matrix = 1;</code>
     * @param array<\Clarifai\Api\ConfusionMatrixEntry>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setMatrix($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Clarifai\Api\ConfusionMatrixEntry::class);
        $this->matrix = $arr;
