...
/**
 * Generated from protobuf message <code>clarifai.api.PostWorkflowVersionsUnPublishRequest</code>
 */
class PostWorkflowVersionsUnPublishRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Clarifai\Api\WorkflowVersionUnPublishRequest::class);
