...
class DatasetVersion extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.clarifai.api.DatasetVersionSummary summary = 11;</code>
     */
     ...
     *           The dataset the dataset version belongs to.
     *     @type \Clarifai\Api\DatasetVersionDatasetFilterConfig $dataset_filter_config
     *           The dataset version will be generated based on a single dataset filter.
     *     @type \Clarifai\Api\Status\Status $status
     *           Status for this dataset version.
     *     @type string $description
     *           Description of the dataset version
     *     @type \Clarifai\Api\DatasetVersionSummary $summary
     *           Dataset version summary
     ...
     * The dataset version will be generated based on a single dataset filter.
     *
     * Generated from protobuf field <code>.clarifai.api.DatasetVersionDatasetFilterConfig dataset_filter_config = 7;</code>
     * @return \Clarifai\Api\DatasetVersionDatasetFilterConfig
     */
    public function getDatasetFilterConfig()
    {
     ...
     *
     * Generated from protobuf field <code>.clarifai.api.DatasetVersionDatasetFilterConfig dataset_filter_config = 7;</code>
     * @param \Clarifai\Api\DatasetVersionDatasetFilterConfig $var
     * @return $this
     */
    public function setDatasetFilterConfig($var)
    {
        GPBUtil::checkMessage($var, \Clarifai\Api\DatasetVersionDatasetFilterConfig::class);
     ...
     *
     * Generated from protobuf field <code>.clarifai.api.DatasetVersionSummary summary = 11;</code>
     * @return \Clarifai\Api\DatasetVersionSummary
     */
     ...
     *
     * Generated from protobuf field <code>.clarifai.api.DatasetVersionSummary summary = 11;</code>
     * @param \Clarifai\Api\DatasetVersionSummary $var
     * @return $this
     */
    public function setSummary($var)
    {
        GPBUtil::checkMessage($var, \Clarifai\Api\DatasetVersionSummary::class);
        $this->summary = $var;
