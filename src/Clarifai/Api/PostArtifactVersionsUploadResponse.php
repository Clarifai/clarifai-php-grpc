...
/**
 * Generated from protobuf message <code>clarifai.api.PostArtifactVersionsUploadResponse</code>
 */
class PostArtifactVersionsUploadResponse extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     *
     * Generated from protobuf field <code>string artifact_version_id = 3;</code>
     */
    protected $artifact_version_id = '';
     ...
     *           Bytes remaining to be uploaded - This is total_size - bytes_uploaded
     *     @type string $artifact_version_id
     *           ID of the artifact version being uploaded
     * }
     */
     ...
     * @return $this
     */
    public function setArtifactVersionId($var)
    {
        GPBUtil::checkString($var, True);
        $this->artifact_version_id = $var;
