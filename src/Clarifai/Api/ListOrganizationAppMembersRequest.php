 ...
 *
 * Generated from protobuf message <code>clarifai.api.ListOrganizationAppMembersRequest</code>
 */
class ListOrganizationAppMembersRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * Generated from protobuf field <code>repeated .clarifai.auth.scope.S required_scopes = 2;</code>
     */
     ...
     *     @type int[]|\Google\Protobuf\Internal\RepeatedField $required_scopes
     *     @type int $page
     *           (optional URL parameter) The page number. Pagination is used to split the results into chunks.
     *           Defaults to 1
     *     @type int $per_page
