...
namespace Clarifai\Api\PostTeamsRequest;
...
/**
 * Generated from protobuf message <code>clarifai.api.PostTeamsRequest.PostTeam</code>
 */
class PostTeam extends \Google\Protobuf\Internal\Message
{
    /**
...
class_alias(PostTeam::class, \Clarifai\Api\PostTeamsRequest_PostTeam::class);
